...
def merge_matrices(path1, path2):
    ...
    answer = None
    while not answer:
        answer = input('Specify parameters to keep: ')
    ...
    answer = input('Specify parameters to keep (can be empty): ')
    ...
    result = None
    while not result:
        result = input('writing the resulting covariance matrix to file:\n')
