...
class euclid_lensing_wwip(Likelihood):
    ...
    def loglkl(self, cosmo, data):
        ...
        #                "you should increase euclid_lensing_wwip.k_max up to at least %g" % (self.l[index_l]/self.r[index_z]))
        ...
        if not (cosmo.nonlinear_method == 0):
            ...
            for index_z in range(self.nzmax-1):
...
#MArchi     for index_l in range(self.nlmax):
        ...
        for index, ell in enumerate(ells):
            ...
            # End Newton
                ...
                if self.use_lmax_lincut:
                    det_cross = 0.
                    for i in range(0,self.nbin-CutBin):
